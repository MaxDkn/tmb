...
export const Navbar = () => {
  // Définir le seuil de scroll (par exemple 300px)
  const scrollThreshold = 300;

  // Navigation: type "anchor" renvoie à une ancre sur la page, type "page" à une page dédiée
  const navigation = [
  ...
  useEffect(() => {
    const controlNavbar = () => {
      if (typeof window !== "undefined") {
        // N'appliquer le masquage que si l'utilisateur a dépassé le seuil
        if (window.scrollY > scrollThreshold) {
          ...
          // Toujours afficher la navbar avant d'atteindre le seuil
          setShowNavbar(true);
        }
  ...
  return (
    ...
    >
      <nav className="container relative flex flex-wrap items-center justify-between p-8 mx-auto lg:justify-between xl:px-1 bg-white dark:bg-trueGray-900">
        ...
        {/* Bouton "Soutenir le projet" et changement de thème */}
